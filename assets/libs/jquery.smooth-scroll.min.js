! function(t) {
    ...
    t.fn.extend({
        ...
        "number" == typeof e ? (n = t.extend({
            ...
            link: null
        }, t.fn.smoothScroll.defaults, e || {}, o), n.scrollElement && (a = "position", "static" == n.scrollElement.css("position") && n.scrollElement.css("position", "relative"))), f = "left" == n.direction ? "scrollLeft" : f, n.scrollElement ? (s = n.scrollElement, /^(?:HTML|BODY)$/.test(s[0].nodeName) || (c = s[f]())) : s = t("html, body").firstScrollable(n.direction), n.beforeScroll.call(s, n), r = "number" == typeof e ? e : l || t(n.scrollTarget)[a]() && t(n.scrollTarget)[a]()[n.direction] || 0, h[f] = r + c + n.offset, i = n.speed, "auto" === i && (i = h[f] || s.scrollTop(), i /= n.autoCoefficent), u = {
            duration: i,
            easing: n.easing,
            complete: function() {
                n.afterScroll.call(n.link, n)
            }
        }, n.step && (u.step = n.step), s.length ? s.stop().animate(h, u) : n.afterScroll.call(n.link, n)
